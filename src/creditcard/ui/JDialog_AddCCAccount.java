...
public class JDialog_AddCCAccount extends AddAccDialog {
	...
	void JButtonOK_actionPerformed(java.awt.event.ActionEvent event)
	{
		...
		if (JRadioButton_Gold.isSelected())
			iAccountFactory = new GoldCCAccountFactory();
		else if (JRadioButton_Silver.isSelected())
			iAccountFactory = new SilverCCAccountFactory();
		else
			iAccountFactory = new PlatinumCCAccountFactory();
		
		IAccount iAccount = iAccountFactory.createAccount(customer, ccnumber);
